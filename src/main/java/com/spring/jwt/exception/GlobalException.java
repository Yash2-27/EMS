...
@Slf4j
public class GlobalException extends org.springframework.web.servlet.mvc.method.annotation.ResponseEntityExceptionHandler {

    // ----------------- SPECIFIC CUSTOM EXCEPTIONS -----------------

    @ExceptionHandler(EmptyFieldException.class)
    public ResponseEntity<ErrorResponseDto> handleEmptyFieldException(EmptyFieldException ex, WebRequest request) {
        log.error("Empty field error: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponseDto> handleClassesNotFound(ClassesNotFoundException ex, WebRequest request) {
        log.error("Classes not found: {}", ex.getMessage());
        ErrorResponseDto errorResponse = new ErrorResponseDto(
                request.getDescription(false),
    ...
    public ResponseEntity<Map<String, Object>> handlePaperPatternNotFound(PaperPatternNotFoundException ex) {
        Map<String, Object> body = new HashMap<>();
        body.put("timestamp", new Date());
        body.put("status", HttpStatus.NOT_FOUND.value());
    ...
    public ResponseEntity<ErrorResponseDto> handleDatabaseError(DataAccessException ex, WebRequest request) {
    ...
    public ResponseEntity<ErrorResponseDto> handleTypeMismatch(MethodArgumentTypeMismatchException ex, WebRequest request) {
        ...
        String error = (ex.getRequiredType() != null)
                ...
                : ex.getName() + " has an invalid type";
...
//
//    @ExceptionHandler(ClassesNotFoundException.class)
//    public ResponseEntity<Map<String, Object>> handleClassesNotFoundException(ClassesNotFoundException ex) {
//        Map<String, Object> body = new HashMap<>();
//        body.put("timestamp", new Date());
//        body.put("status", HttpStatus.NOT_FOUND.value());
//        body.put("error", "Classes Not Found");
//        body.put("message", ex.getMessage());
//        return new ResponseEntity<>(body, HttpStatus.NOT_FOUND);
//    }
//
//    // Handle Empty Fields in Class Creation
//    @ExceptionHandler(EmptyFieldException.class)
